...
Gem::Specification.new do |gem|
  ...
  gem.add_development_dependency 'pry-byebug', '~>3.5.1'
  gem.add_development_dependency 'rspec', '~>3.7.0'
  gem.add_development_dependency 'rubocop', '~>0.52.1'
  gem.add_development_dependency 'rubocop-rspec', '~>1.22.2'
  gem.add_development_dependency 'ruby-prof', '~>0.17.0'
end
